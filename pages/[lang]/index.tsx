...
const Page: PageEl = (props, refresh, getProps, onConnected, dies, z) => {
  ...
  return <div>
    ...
    <Window title="Worker Examples" style={{ paddingBottom: 10 }}>
      <w-cc style={{ gap: 5, padding: 5 }}>
        <b-200 onClick={async () => { Router.push(z.root + "/examples/db/insert") }}></b-200>
        <b-200 onClick={async () => { Router.push(z.root + "/examples/db/delete") }}></b-200>
        <b-200 onClick={async () => { Router.push(z.root + "/examples/db/query") }}></b-200>
        <b-200 onClick={async () => { Router.push(z.root + "/examples/db/update") }}></b-200>
      </w-cc>
    </Window>
